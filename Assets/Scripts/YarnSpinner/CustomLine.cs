...
/// by <see cref="CustomLine"/> to handle animating the presentation of lines.
/// </summary>
...
/// elements.
/// </summary>
public class CustomLine : DialogueViewBase
{
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// If the <see cref="CustomLine"/> receives a line that does not contain
    ...
    /// finished presenting their lines. If a <see cref="CustomLine"/> doesn't
